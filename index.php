...
// Application Classes
require_once(DIR_SYSTEM . 'library/vishdata.php');
require_once(DIR_SYSTEM . 'library/retail.php');
require_once(DIR_SYSTEM . 'library/testupdate.php');
require_once(DIR_SYSTEM . 'library/currency.php');
require_once(DIR_SYSTEM . 'library/tax.php');
require_once(DIR_SYSTEM . 'library/weight-hari.php');
...
//this is newly added bock
$loader = new Loader($registry1);
$registry->set('load', $loader1);
